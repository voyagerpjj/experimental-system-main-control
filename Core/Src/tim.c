...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = M1_CLK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(M1_CLK_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PB0     ------> TIM3_CH3
    */
    GPIO_InitStruct.Pin = M2_CLK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(M2_CLK_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PB6     ------> TIM4_CH1
    */
    GPIO_InitStruct.Pin = M3_CLK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(M3_CLK_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM5_MspPostInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    GPIO_InitStruct.Pin = M4_CLK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(M4_CLK_GPIO_Port, &GPIO_InitStruct);
